...
<head>
  ...
  <title><?php echo $data['blog-title'] ?></title>
      ...
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            ...
            <li><?php echo $data['blog-title'] ?></li>
          </ol>
        </div>
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry entry-single">
              ...
              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="blog-single.php?id=<?php echo $data['blog-id'] ?> "><time datetime="2020-01-01"><?php echo $data['blog-time'] ?></time></a></li>
                </ul>
              </div>
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item recent-posts">
                ...
                ?>
                  ...
                  <h4><a href="blog-single.php"><?php echo $data['blog-title'] ?></a></h4>
